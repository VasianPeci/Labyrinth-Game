...
public class RegisterPanel extends JPanel{
	...
	public RegisterPanel() {
		...
		registerButton.setBounds(215, 500, 170, 40);
		registerButton.setBorder(border);
		registerButton.setFocusable(false);
		registerButton.setForeground(Color.white);
		registerButton.setBackground(Color.black);
		if(joystix != null) {
			registerButton.setFont(joystix.deriveFont(15f));
		} else {
		...
		loginButton.setBounds(460, 530, 110, 40);
		loginButton.setBorder(border);
		loginButton.setFocusable(false);
		loginButton.setForeground(Color.white);
		loginButton.setBackground(Color.black);
		if(joystix != null) {
			loginButton.setFont(joystix.deriveFont(15f));
		} else {
